...
# 基础配置
DASHSCOPE_API_KEY = os.getenv('DASHSCOPE_API_KEY', 'sk-你的DashScope_API_KEY')  # 优先从环境变量读取
...
#  API服务
ASYNC_DATABASE_URL = "mysql+aiomysql://root:dujiafeng@localhost:3306/mem_rag?charset=utf8"
SALT_SUFFIX = "MYRAG"
